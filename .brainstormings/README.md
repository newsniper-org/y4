...
| [20260618-223701-capability-bound-allocation.md](20260618-223701-capability-bound-allocation.md) | Capability-bound allocation (front-end 직교 cross-cutting layer, Y4 고유) — partition-keyed zone(P0..3, I1 메모리 따름정리, cross-tenant UAF 차단) / partition memory quota(lease §4 빈 칸) / lease-lifecycle bulk reclaim(I4/I6) / sealed zero-on-free / C5 capability contract / `CapabilityAlloc<F>` wrapper.  기존 allocator 누구도 안 한 capability-aware (paper §6.1 최강 차별점) | 2026-06-18 22:37 | brainstorming (일부 ⏳ hiu_abi) |
