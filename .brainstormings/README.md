...
| [20260618-231936-cross-platform-strategy.md](20260618-231936-cross-platform-strategy.md) | Cross-platform multi-ISA (AArch64 / RISC-V RV64GC / POWER64 LE+BE / ARCv3) — ISA-independent core 최대화(Y4 가치 대부분 arch-neutral, §0.5 atomic-free 가 arch memory model 회피) / virtualization=cpu_virt_compat 의 arch 축 확장(abstract AV + `<topic>_<arch>.rs`) / endian=LE 우선+POWER BE type-safe newtype / verified base 차등(seL4 verified AArch64·RISC-V vs 미지원 POWER·ARC 포팅 선결) / 우선순위 AArch64→RISC-V→POWER→ARCv3 | 2026-06-18 23:19 | brainstorming |
