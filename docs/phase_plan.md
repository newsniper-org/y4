...
> 않는다.
>
> **갱신 (2026-09-14, 사용자 지시):** 그 spec 이 이제 **`docs/y4_abi.md`**
> (v0 draft — 게스트↔하이퍼바이저 ABI: hypercall + capability + 가상 디바이스)
> 로 **존재**한다.  여전히 Phase C *본체* 차단 의존이 아니라 **y4-drivers
> 진입 선행조건**(그 문서 v1.0 frozen 시).
>
