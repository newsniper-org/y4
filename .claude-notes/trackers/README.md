...
| `smt-cross-validation-tracker.md` | Verus 의 z3 ↔ OxiZ dual backend (P-redesign.2 §3.6) cross-validation 실험 plan + 측정 결과.  paper artifact 의 Reproducible 자격 evidence + 학술적 차별점 §6.1.8 의 quantitative support | **2026-06-01 (active)** | `adsmt-integration-tracker.md` §8 + `verus_to_isabelle.md` §3.6 + `power_arch.md` §6.5 (vii) |
