...
> **Hold pattern (2026-05-29 사용자 정책)**: adsmt v1.0 정식 release
> 가 Y4 verification workflow **전체 재설계** 의 trigger.  release 전
> 까지 verification workflow 의 본격 변경 X — 본 §5 의 spec 갱신은
> v1.0 도달 시점에 일괄 진입.  관련 memory:
...
| (대기) | adsmt v1.0 release | **Y4 verification workflow 전체 재설계 진입** + §5 ledger 의 v1.x patch 본격 | §5 |
