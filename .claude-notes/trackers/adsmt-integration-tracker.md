...
> **Hold pattern (2026-05-29 사용자 정책, 2026-06-01 부분 해제)**:
> adsmt v1.0 정식 release 가 Y4 verification workflow **전체 재설계**
> 의 trigger.  Stable release 도달 전까지 spec 의 v1.x patch 본격 적용
> 은 보류 — 단 **재설계 논의는 진행** (2026-06-01 사용자 trigger).
> testing 브랜치가 v1.0.0-rc.2 단계 + "preparations for stable v1.0.0
> release" commit (`450b986`) 으로 release 매우 임박.  관련 memory:
> `feedback_adsmt_v1_verification_redesign.md`.
...
| **2026-06-01** | **Y4 측 verification workflow 재설계 논의 시작** | 사용자 trigger (release 임박 인지) — hold pattern 부분 해제 | §5 (Hold pattern banner 갱신) |
| (임박) | adsmt v1.0.0 stable release | **Y4 verification workflow 전체 재설계 본격 진입** + §5 ledger 의 v1.x patch 본격 | §5 |
